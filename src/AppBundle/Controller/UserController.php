        ...
        */
        ...
        public function postUserAction(Request $request)
        {
            ...
            if ($form->isValid()) {
                ...
                ->setFrom('reservations@leguichet.mg')
                ...
                ->setBody(
                    $this->renderView(
                        ...
                        array('username'=>$users->getUsername(),
                              ...
                              'email_encode'=>base64_encode($users->getEmail()))
                    ),
                    'text/html'
                );
            $this->get('mailer')->send($message);
                ...
                return new JsonResponse(['message' => 'L\'email de vérification a été envoyé',
                                        'email'=>'Nous venons d\'envoyer un e-mail de vérification à' .$users->getEmail(). 'Veuillez cliquer sur le lien dans l\'e-mail pour activer votre compte'], Response::HTTP_CREATED);
            } else {
                return $form;
            }
        }
